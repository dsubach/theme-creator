...
import { Select, makeStyles, Theme, createStyles } from '@material-ui/core';
...
const getFontSizeUnit = (value: string) => {
...
const getFontSizeValue = (value: number | string, fontSizeUnit: string | undefined) => {
...
function FontSizeInput({ value, onChange, property }: Required<IInputProps>) {
